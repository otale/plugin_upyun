...
public class FileBucketDemo {
    ...
    // 运行前先设置好以下三个参数
    private static final String BUCKET_NAME = "taletest";
    private static final String OPERATOR_NAME = "taletest";
    private static final String OPERATOR_PWD = "taletest123";
     ...
     * 本地待上传的测试文件
     */
    private static final String SAMPLE_TXT_FILE = "/Users/biezhi/workspace/projects/java/plugin_upyun/pom.xml";
...
//		System.out.println("2.上传 " + filePath2 + isSuccess(result2));
        ...
        boolean result3 = upyun.writeFile("/pom.xml", file, true);
